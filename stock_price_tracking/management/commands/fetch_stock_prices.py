...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Fetch all stock tracking entries
        ...
        for tracking in stock_trackings:
            ...
            if company_symbol in stock_data:
                ...
                # Check if price triggers are met
                if stock_price:
                    # Check price increase trigger
    ...
    def send_alert(self, tracking, stock_price, trigger_type):
        # Get the user who is tracking the stock
        user = tracking.user
        company_name = tracking.company.name
        company_symbol = tracking.company.stock_symbol

        # Determine the alert message based on trigger type
        ...
        try:
            send_mail(
                ...
                message=message,
                from_email="dreamhigh.bibek@gmail.com",  # Replace with your email address
